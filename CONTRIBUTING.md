...
1. Clone the repository:
   ...
   cd AgenticADB
   ```
2. Make sure you are using **Node.js 20+**.
...
**Strict Rule:** Do not test against physical devices. All tests must pass using the mocked `vitest` suite.
...
3. Make sure you've formatted and linted the code using `npm run check`.
...
6. A maintainer will review your code. You must pass all checks and the mocked `vitest` suite before your PR is merged.
